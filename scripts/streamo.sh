...
finish() {
  ...
  echo ""
  echo -e "  ${YW}Aktualisieren${CL}"
  echo -e "   Im Container:     ${DGN}update${CL}"
  echo -e "   Vom Host aus:     ${DGN}pct exec ${CTID} -- update${CL}"
  echo ""
  echo -e "  ${YW}Weitere Befehle${CL}"
  echo -e "   Konsole öffnen    ${DGN}pct enter ${CTID}${CL}"
  echo -e "   Alle Befehle      ${DGN}pct exec ${CTID} -- streamo${CL}"
